  ...
  <section class="container home-states">
    ...
    <section class="home-about">
        ...
        <div class="home-about__image-container">
            <img class="home-about__image" src="./wp-content/themes/aether/assets/images/aboutbg.png" alt="about background image">
        </div>
    </section>
    ...
    <section class="container home-services">
        <ul class="home-services__list">
            ...
            <li class="home-services__item">
                <div class="home-service__image-container">
                    <picture class="home-service__image">
                        <source media="(min-width: 650px)" srcset="./wp-content/themes/aether/assets/images/service1_desktop.png">
                        <img src="./wp-content/themes/aether/assets/images/service1_mobile.png" alt="service mobile">
                    </picture>
                </div>
            ...
            <li class="home-services__item">
                <div class="home-service__image-container">
                    <picture class="home-service__image">
                        <source media="(min-width: 650px)" srcset="./wp-content/themes/aether/assets/images/service2_desktop.png">
                        <img src="./wp-content/themes/aether/assets/images/service2_mobile.png" alt="service mobile">
                    </picture>
                </div>
                <div class="home-service__content">
                    <h2 class="home-service__heading">
            ...
            <li class="home-services__item">
                <div class="home-service__image-container">
                    <picture class="home-service__image">
                        <source media="(min-width: 650px)" srcset="./wp-content/themes/aether/assets/images/service3_desktop.png">
                        <img src="./wp-content/themes/aether/assets/images/service3_mobile.png" alt="service mobile">
                    </picture>
                </div>
                <div class="home-service__content">
                    <h2 class="home-service__heading">
            ...
            <li class="home-services__item">
                <div class="home-service__image-container">
                    <picture class="home-service__image">
                        <source media="(min-width: 650px)" srcset="./wp-content/themes/aether/assets/images/service4_desktop.png">
                        <img src="./wp-content/themes/aether/assets/images/service4_mobile.png" alt="service mobile">
                    </picture>
                </div>
                <div class="home-service__content">
                    <h2 class="home-service__heading">
        ...
        <div class="home-studies__grid">
            <div class="home-study">
                <div class="home-study__image-container">
                    <img class="home-study__image" src="./wp-content/themes/aether/assets/images/study_1.png" alt="home Studies">
                </div>
            ...
            <div class="home-study">
                <div class="home-study__image-container">
                    <img class="home-study__image" src="./wp-content/themes/aether/assets/images/study_2.png" alt="home Studies">
                </div>
                <div class="home-study-content">
            ...
            <div class="home-study">
                <div class="home-study__image-container">
                    <img class="home-study__image" src="./wp-content/themes/aether/assets/images/study_3.png" alt="home Studies">
                </div>
                <div class="home-study-content">
            ...
            <div class="home-study">
                <div class="home-study__image-container">
                    <img class="home-study__image" src="./wp-content/themes/aether/assets/images/study_4.png" alt="home Studies">
                </div>
                <div class="home-study-content">
            ...
            <div class="home-study">
                <div class="home-study__image-container">
                    <img class="home-study__image" src="./wp-content/themes/aether/assets/images/study_5.png" alt="ARMADA AI">
                </div>
                <div class="home-study-content">
                ...
                <ul class="home-team__list">
                    <li class="home-member">
                        <figure class="home-member__fegure">
                            <img class="home-member__photo" src="./wp-content/themes/aether/assets/images/1.png" alt="BEN Moataz">
                    ...
                    <li class="home-member">
                        <figure class="home-member__fegure">
                            <img class="home-member__photo" src="./wp-content/themes/aether/assets/images/2.png" alt="NICHOLAS Angerame">
                            <figcaption class="home-member__info">
                    ...
                    <li class="home-member">
                        <figure class="home-member__fegure">
                            <img class="home-member__photo" src="./wp-content/themes/aether/assets/images/3.png" alt="VICTORIA Bittner">
                            <figcaption class="home-member__info">
                    ...
                    <li class="home-member">
                        <figure class="home-member__fegure">
                            <img class="home-member__photo" src="./wp-content/themes/aether/assets/images/4.png" alt="GIORDANO Morichi">
                            <figcaption class="home-member__info">
